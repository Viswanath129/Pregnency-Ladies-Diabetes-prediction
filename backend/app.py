...
FILES = {
    ...
    "ensemble": "ensemble_decision_engine.joblib",
...
async def lifespan(app: FastAPI):
    """
    Handle lifespan events for FastAPI: load models on startup and clean up.
    """
    ...
    try:
        ...
        MODELS["ensemble"] = joblib.load(os.path.join(BASE_DIR, FILES["ensemble"]))
